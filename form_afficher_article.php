...
$titre = "Articles"; //Titre à changer sur chaque page
...
if (isset($_POST['vitrineadd'])) :
    $bdd->exec('INSERT INTO vitrine(\'ISBN_ISSN\') VALUES ((SELECT ISBN_ISSN FROM article WHERE ISBN_ISSN = \'' . $_POST['vitrineadd'] . '\')');
    echo "<meta http-equiv='refresh' content='0; url='" . $_SERVER['PHP_SELF'] . "'>";
endif;
?>
